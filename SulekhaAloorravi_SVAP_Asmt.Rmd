---
title: "Forecasting population, forest area and food production of World countries using an R Dashboard"
...
[https://tinkleolive.shinyapps.io/rapp/](https://tinkleolive.shinyapps.io/rapp/)
...
![FAO Data](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\fao.png)


## Refine

Downloaded data had to be refined since its struture was completely unusable for this analysis. 
Extracted zip file was exceeding 1 GB and it required a lot of normalization to be done before using it in R. So I used an SQL database to normalize this data and convert it into R friendly csv data that can be read into a dataframe.

***Downloaded data***
![Downloaded data](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\downloadeddata.png)

***SQLite Database for FAO data***
![SQLite Database for FAO data](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\sqldb.png)

***Refined csv data***
![CSV data](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\csv.png)


[Input csv file](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\data\FoodBalanceSheet.csv)
...
Graphs as mentioned in the above section were created to explore data interactively.
Shiny dashboard for the same is as follows:

***1. Heatmap Tab:***

![Heatmap](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\heatmap.png)

***2. Crosstalk Tab:***

![Crosstalk](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\crosstalk.png)

***3. Three-dimensional View Tab:***

![3D View](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\cube.png)
...
![Forecast](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\forecast.png)

## Communicate Insight

From the below charts, trends of Earth's forecasted data until 2023 are as follows: --Select any country--

1. Agricultural area is becoming less in some countries where as it is increasing in other countries. 
![Agriculture](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\agri.png)
   
2. Population trend in various countries seem to be uniformly increasing.  
![Population](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\population.png)

3. Production of food seems to be uniformly increasing.
![Production](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\production.png)

4. Forest either seems to be decreasing or remaining stable in various countries but no evident increase.
![Forest](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\forest.png)


5. There is no significant increase in planted forest across the world.
![Plants](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\planted.png)

6. Food wasted across the world is following a stable trend in parallel to the production.
![Waste](E:\Sulekhas BOOKSHELF\GreatLakes\SVAP\Assignment2\waste.png)
